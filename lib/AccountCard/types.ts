...
import { ComponentBaseWithClassName, GridItemsAlignment, GridJustify, GridSizes, HPositionLR } from "@polkadot-ui/react/types";
...
export interface ExtraComponentProps extends CommonParams, ComponentBaseWithClassName {
